...
(function() {
  var Config, GLOBALX, GLOBALY, Moon, SCALE, current_time, draw_grid, helpText, init, moonText, moons, pos_to_percent, redraw, svgDoc, timeInput, timeText;
  ...
  timeInput = d3.select("body").append("input").attr("type", "text").attr("size", "10").style("font-family", "sans-serif").style("font-size", "20px").style("background-color", "transparent").style("text-shadow", "1px 1px #111").style("text-align", "right").style("color", "white").style("border", "none").style("position", "absolute").style("display", "block").style("top", "80%").style("right", "10%").attr("value", "0").on("change", () => {
    current_time = parseFloat(timeInput.property("value"), 10);
    return redraw();
  });
  ...
  redraw = function() {
    ...
    // Update time
    return timeInput.property("value", `${current_time.toFixed(2)}`);
  };
...
// Generated by CoffeeScript 2.3.2
(function() {
  var Config, MoonClass, PI, TIME_CONSTANT, TIME_OFFSET, TWO_PI, parse_moons, readyPromise;
